...
export default function SectionTwo() {
  return (
    <div data-aos="fade-up" data-aos-duration="1000" className="flex flex-col space-y-3 md:space-y-8 bg-blue-500 mx-auto rounded-lg md:py-20 w-11/12 py-6 px-4">
      <h2 className="text-xl font-semibold md:text-2xl md:mx-auto md:text-center md:w-8/12 text-white lg:text-3xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 md:gap-5 gap-2 md:w-10/12 md:mx-auto">
        <div className="px-2 py-1 text-xs md:text-sm border-2 rounded-full text-center font-semibold text-white cursor-pointer hover:bg-orange-400 transition-all duration-200">
          All Works [20]
        </div>
        <div className="px-2 py-1 text-xs md:text-sm border-2 rounded-full text-center  text-white font-semibold cursor-pointer hover:bg-orange-400 transition-all duration-200">
          Digital Marketing [5]
        </div>
        <div className="px-2 py-1 text-xs md:text-sm border-2 rounded-full text-center font-semibold text-white cursor-pointer hover:bg-orange-400 transition-all duration-200">
          UI / UX [10]
      ...
      <div className="flex flex-col md:flex-row py-5 space-x-3 md:space-x-10 overflow-hidden lg:justify-between lg:ps-24">
        <div>
